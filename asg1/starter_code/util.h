...
//
// vector_join
//    Take a wordvec and a string token and join the strings of
//    the vector with the token between each element.

string vector_join(const wordvec& v, const string& token);
